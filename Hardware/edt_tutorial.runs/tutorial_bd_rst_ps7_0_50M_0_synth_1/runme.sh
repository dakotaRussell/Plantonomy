...
HD_PWD='/home/dev/edt_tutorial/edt_tutorial.runs/tutorial_bd_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tutorial_bd_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tutorial_bd_rst_ps7_0_50M_0.tcl
